#!/bin/bash
## Jul 1, 2026:
# qsub -wd /broad/hptmp/mesbah/RefSeq/tmpdir -R y -t 1-22 -l h_vmem=10G -l h_rt=20:00:00 -pe smp 4 -binding linear:4 -N prep_mgbb53k /medpop/esp2/mesbah/tools/meta-gwas-of-clonal-hematopoiesis/06.COJO/00.prepMGBB53k.Reference.sh 4 /medpop/esp2/mesbah/projects/Meta_GWAS/n650k/multi_ancestry_summary/mgbb53k.multiAncestry.CHIP.ids /broad/hptmp/mesbah/RefSeq/mgbb53k "bgen_v1.2"

# for chr in {1..22}; do /medpop/esp2/mesbah/tools/qcTool/bin/qctool_v2.0.7 -g /medpop/esp2/projects/MGB_Biobank/imputation/53K_GSA/release/bgen/GSA_53K.merged.chr22.bgen -s /medpop/esp2/projects/MGB_Biobank/imputation/53K_GSA/release/bgen/GSA_53K.merged.chr22.sample -incl-sample /medpop/esp2/mesbah/projects/Meta_GWAS/n650k/multi_ancestry_summary/mgbb53k.multiAncestry.CHIP.ids ; done  
...
# Samples to keep: /medpop/esp2/mesbah/projects/Meta_GWAS/n650k/multi_ancestry_summary/mgbb53k.multiAncestry.CHIP.ids
...
${QCTOOL2} \
	...
	-og ${outDir}/GSA_53K.merged.chr${chr}.mgbb53k_CHIP_samples.bgen \
	-os ${outDir}/GSA_53K.merged.chr${chr}.mgbb53k_CHIP_samples.sample \
	-ofiletype ${outfile_type}
...
#
bgenix \
	-g ${outDir}/GSA_53K.merged.chr${chr}.mgbb53k_CHIP_samples.bgen \
	-index

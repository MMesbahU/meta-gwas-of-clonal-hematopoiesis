...
## qsub -wd /medpop/esp2/mesbah/projects/Meta_GWAS/MetaGWAS_N900k/gwas/aou/metadata -l h_rt=30:00:00 -l h_vmem=20G -pe smp 1 -binding linear:1 -R y -N combine_gwas_files /medpop/esp2/mesbah/tools/CHIP_metaAnalysis/02.GWAS/1.regenie_GWAS/AoU/gwas_summary.sh /medpop/esp2/mesbah/projects/Meta_GWAS/MetaGWAS_N900k/gwas/aou
##
...
while read ANC; do
	...
	while read pheno; do
		...
		for file in ${outDir}/${ANC}/chr{1..22}.${ANC}.AoU_v71.has${pheno}.regenie.tsv.gz; do

...
<<<<<<< HEAD
################# August 2023 #######################
## topmed 74k + ukb 200k + ukb 250k + mgb 53k + biovu 54k
## no AoU summary at this stage
## while read phenotype; do qsub -R y -wd /broad/hptmp/mesbah/dataset/ch_gwas/tmpdir -pe smp 1 -binding linear:1 -l h_vmem=40G -l h_rt=20:00:00 -N metal_meta4${phenotype} /medpop/esp2/mesbah/tools/CHIP_metaAnalysis/03.Meta-Analysis/02.GWAMA/02.METAL.Meta_Analysis.sh /medpop/esp2/mesbah/tools/CHIP_metaAnalysis/03.Meta-Analysis/02.GWAMA/input_files/metal_directive.topmed74k_ukb200k250k_mgbb53k_biovu54k.multiAnc.${phenotype}.Aug2023.txt /medpop/esp/mesbah/GWAS_CHIP/topmed_GWAS/topmed2021/topmed2021_has${phenotype}.tsv.gz /medpop/esp/mesbah/GWAS_CHIP/inputUKB/2023_ukbb/rap_gwas/has${phenotype}.chr1_22.ukb200k.regenie.tsv.gz /medpop/esp/mesbah/GWAS_CHIP/inputUKB/2023_ukbb/rap_gwas/has${phenotype}.chr1_22.ukb250k.regenie.tsv.gz /medpop/esp/mesbah/GWAS_CHIP/AoU/chr1_22.AoU_multiAnc_2023.has${phenotype}.regenie.tsv.gz /medpop/esp/mesbah/GWAS_CHIP/MGBB53k/mgbb53k_gwama.chr1_22.has${phenotype}.tsv.gz /medpop/esp/mesbah/GWAS_CHIP/BioVU/BioVU.saige_has${phenotype}_results_merged_subset.tsv.gz /broad/hptmp/mesbah/dataset/ch_gwas/metalGWAS.multiAnc.${phenotype}.topmed74k_ukb200k250k_mgbb53k_biovu54k.Aug2023 /broad/hptmp/mesbah/dataset/ch_gwas /medpop/esp2/mesbah/tools/CHIP_metaAnalysis/03.Meta-Analysis/03.Plots/01.plot.metaGWAS.R /broad/hptmp/mesbah/dataset/ch_gwas/summuray_for_plot.topmed74k_ukb450k_mgbb53k_biovu54k.multiAnc.${phenotype}.Aug2023.tsv ${phenotype} /broad/hptmp/mesbah/dataset/ch_gwas/unsorted_metal.topmed74k_ukb200k250k_mgbb53k_biovu54k.multiAnc.${phenotype}.Aug2023.vcf /broad/hptmp/mesbah/dataset/ch_gwas/sorted_metal.topmed74k_ukb200k250k_mgbb53k_biovu54k.multiAnc.${phenotype}.Aug2023.vcf; done < <(echo -e "CH\nDNMT3A\nTET2")
...
###############
>>>>>>> 821f405ecae6e0a496fef5f0babb940b408b6371
#### Multi-ancestry 
## 

...
output_plot_perc = sys.argv[2]
title_var = sys.argv[3]
EAF_threshold = float(sys.argv[4])
X_percent = float(sys.argv[5])
...
df_perc = df[(df['N'] >= (max_n * X_percent) )]
...
plot_manhattan(df_perc, output_plot_perc, title_var)

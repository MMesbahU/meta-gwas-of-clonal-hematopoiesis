#!/bin/bash
#SBATCH --job-name=onek1k_cell_sub
#SBATCH --mem=64G
#SBATCH --partition=bigmem
#SBATCH --cpus-per-task=1
#SBATCH --time=6:00:00
#SBATCH --output=/data/cteu/2_users/zyu_lab/linke/chip_gwas_rev/logs/onek1k_50kcells_sensi_%A_%a.log
#SBATCH --array=20
...
manifest="/data/cteu/2_users/zyu_lab/linke/chip_gwas_rev/Data/sc_annot_files_subsets/helper_files/onek1k_cell_subsample_manifest.txt"
gs_file="/data/cteu/2_users/zyu_lab/linke/chip_gwas_rev/Data/scDRS/munged/chip_dnmt3a_tet2_munged_n1000_ensg.gs"
...
out_folder="/data/cteu/2_users/zyu_lab/linke/chip_gwas_rev/Results/sensitivity_analysis/onek1k_50kcells_sub/rep${rep}"

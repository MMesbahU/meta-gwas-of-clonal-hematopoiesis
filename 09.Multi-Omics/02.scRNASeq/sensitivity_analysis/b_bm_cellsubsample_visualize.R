...
##### 02 - files #####
# =============================================================================
# 1. Load main result (full BM, full gene set)
# =============================================================================
...
cell_sub_dir <- "Results/sensitivity_analysis/bm_50kcells_sub"
n_reps      <- 20
...
write.table(main_results, "Results/sensitivity_analysis/bm_cellsubsample_main_results.tsv",
            sep="\t", row.names = F, quote = F)
write.table(cell_sub_results, "Results/sensitivity_analysis/bm_cellsubsample_n20sensi_results.tsv",
            sep="\t", row.names = F, quote = F)
...
# dir.create("Results/figures/bm_sensitivity", recursive = TRUE, showWarnings = FALSE)

for (trait in traits) {
    p <- plot_sensitivity(trait)
    ggsave(
        paste0("Results/figures/bm_sensitivity/bm_cell_subsample_", trait, ".png"),
...
print(p_combined)
ggsave("Results/figures/bm_sensitivity/bm_cell_subsample_combined.png",

...
## qsub -R y -wd /broad/hptmp/mesbah/dataset/ch_gwas/tmpdir -t 1-$(wc -l /medpop/esp2/mesbah/projects/Meta_GWAS/MetaGWAS_N900k/GWAMA/mgbb_gwas_summary_list.list |awk '{print $1}') -pe smp 1 -binding linear:1 -l h_vmem=30G -l h_rt=10:00:00 -N hg38_to_hg37_mgbb /medpop/esp2/mesbah/tools/CHIP_metaAnalysis/11.etcs/mgbb_hg38_to_hg37.sh /medpop/esp2/mesbah/projects/Meta_GWAS/MetaGWAS_N900k/GWAMA/mgbb_gwas_summary_list.list /medpop/esp2/mesbah/tools/LiftOVer/grch38_to_grch37.over.chain /medpop/esp2/mesbah/tools/LiftOVer/picard.jar /broad/hptmp/mesbah/RefSeq/human_g1k_v37.fasta /broad/hptmp/mesbah/dataset/ch_gwas/GWAMA/input/mgbb/vcf /broad/hptmp/mesbah/dataset/ch_gwas/GWAMA/input/mgbb/vcf ".tsv.gz"
...
## 
#####
# ls /broad/hptmp/mesbah/dataset/ch_gwas/GWAMA/input/mgbb/*.regenie.tsv.gz | awk '{print $NF}' > /medpop/esp2/mesbah/projects/Meta_GWAS/MetaGWAS_N900k/GWAMA/mgbb_gwas_summary_list.list

# zcat /broad/hptmp/mesbah/dataset/ch_gwas/GWAMA/input/mgbb/hasCHvaf10.chr1_22.Male.regenie.tsv.gz | head -2
# SNPID	REF	ALT	AAF	BETA	SE	P	N	INFO
# chr1:10894:G:A	G	A	0.000983803	-0.371862	1.129684	0.742025	20983	0.329068
###############################
...
echo -e '##INFO=<ID=EffectAllele,Number=1,Type=String,Description="Effect allele (Alternative Allele is the effect allele in topmed_imputed MGBB gwas)">' >> ${inVCF}
